...
class SecurityAuditEngine:
    ...
    def generate_report(self):
        ...
        # 헤더와 데이터의 최대 길이를 고려하여 너비를 동적으로 조정하고 1.2배 늘립니다.
        col_widths = {cat: int(max(len(cat), 10) * 1.2) for cat in categories_for_display}
        ...
        for cat in categories_for_display:
            separator_parts.append("-" * col_widths[cat])
